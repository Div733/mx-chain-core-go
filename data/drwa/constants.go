...
// IsValid reports whether code is one of the 15 concrete denial codes emitted
// by the DRWA gate. Returns false for DenialUnknown and the empty string.
// Use IsValid() as the storage guard before writing a denial record to the
// compliance index.
